...
const ContactPage = () => {
  const initMap = useCallback(() => {
    ...
    const mapOptions = {
      center: new window.naver.maps.LatLng(37.535203, 127.083834),
      zoom: 17,
    };
    ...
    new window.naver.maps.Marker({
      position: new window.naver.maps.LatLng(37.535203, 127.083834),
      map,
      title: "키알라 베이커리",
    });
  }, []);
  ...
  return (
    <main>
      <Script
        src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpKeyId=3e4y3k50iq"
